...
import org.uamobile.iosched.appwidget.ScheduleWidgetProvider;
import org.uamobile.iosched.provider.ScheduleContract.Announcements;
import org.uamobile.iosched.provider.ScheduleContract.Blocks;
import org.uamobile.iosched.provider.ScheduleContract.Feedback;
import org.uamobile.iosched.provider.ScheduleContract.MapMarkers;
import org.uamobile.iosched.provider.ScheduleContract.MapTiles;
import org.uamobile.iosched.provider.ScheduleContract.Rooms;
import org.uamobile.iosched.provider.ScheduleContract.Sandbox;
import org.uamobile.iosched.provider.ScheduleContract.SearchSuggest;
import org.uamobile.iosched.provider.ScheduleContract.Sessions;
import org.uamobile.iosched.provider.ScheduleContract.Speakers;
import org.uamobile.iosched.provider.ScheduleContract.Tracks;
import org.uamobile.iosched.provider.ScheduleDatabase.SessionsSearchColumns;
import org.uamobile.iosched.provider.ScheduleDatabase.SessionsSpeakers;
import org.uamobile.iosched.provider.ScheduleDatabase.SessionsTracks;
import org.uamobile.iosched.provider.ScheduleDatabase.Tables;
import org.uamobile.iosched.util.SelectionBuilder;
...
import static org.uamobile.iosched.util.LogUtils.LOGV;
 ...
 * by {@link org.uamobile.iosched.sync.SyncHelper}, and queried by various
